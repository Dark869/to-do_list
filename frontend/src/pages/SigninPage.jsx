...
function SigninPage() {
  ...
  return (
    <div className="bg-zinc-800 min-h-screen">
      ...
      <div className="w-11/12 sm:w-3/4 md:w-1/2 lg:w-1/3 bg-neutral-900 rounded-3xl flex fixed flex-col items-center p-6 sm:p-8 content-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
